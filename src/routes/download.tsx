...
export const Route = createFileRoute('/download')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Download Sigil for Mac, Windows, or Linux. Free, open source, no signups.' },
    ],
  }),
...
const PLATFORMS: { os: OS; label: string; symbol: string; file: string; note: string }[] = [
  { os: 'mac',     label: 'macOS',   symbol: '⌘', file: 'Sigil.dmg',       note: 'Apple Silicon + Intel · drag to Applications' },
  { os: 'windows', label: 'Windows', symbol: '⊞', file: 'Sigil-setup.exe', note: 'Windows 10 or newer · runs the installer' },
  { os: 'linux',   label: 'Linux',   symbol: '⌂', file: 'Sigil.AppImage',  note: 'AppImage · auto-updates · runs anywhere' },
]

const LINUX_EXTRAS = [
  { file: 'Sigil.deb', note: '.deb — Debian / Ubuntu · update via apt' },
  { file: 'Sigil.rpm', note: '.rpm — Fedora / RHEL / openSUSE · update via dnf' },
]
      ...
      <div className="dl-page">
        <div className="wrap">
          ...
          <div className="dl-hero">
            ...
            <p className="dl-sub">
              Free forever · open source · no signups · keys never leave your machine
            </p>
          </div>
          ...
          <div className="dl-notes">
            <div className="dl-note">
              ...
              <span className="dl-note-val">AppImage and the macOS/Windows installers update automatically in-app. deb and rpm update through your package manager.</span>
            </div>
            <div className="dl-note">
              ...
              <span className="dl-note-val">
                ...
                <a className="dl-inline-link" href={RELEASES} target="_blank" rel="noopener noreferrer">release notes</a>.
              </span>
            </div>
            <div className="dl-note">
              <span className="dl-note-key">[ SOURCE ]</span>
              <span className="dl-note-val">
                <a className="dl-inline-link" href="https://github.com/sigil-oss/sigil.app" target="_blank" rel="noopener noreferrer">github.com/sigil-oss/sigil.app</a>
          ...
          <div className="dl-meta">
            <Link to="/" className="dl-meta-link">← Back to site</Link>
            <Link to="/docs" className="dl-meta-link">Integration docs →</Link>
          </div>
