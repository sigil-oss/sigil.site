	...
	head: () => ({
		meta: [
			...
			{ title: "Sigil — Your QUBIC, on your computer" },
			{
				name: "description",
				content:
					"A desktop wallet for QUBIC that stays on your computer. Your keys, your control — no signups, no servers. Mac, Windows, Linux.",
			},
			{ property: "og:title", content: "Sigil — Your QUBIC, on your computer" },
			{
				property: "og:description",
				content:
					"A desktop wallet that stays yours. Your keys never leave your device.",
			},
			...
			{
				name: "twitter:title",
				content: "Sigil — Your QUBIC, on your computer",
			},
			{
